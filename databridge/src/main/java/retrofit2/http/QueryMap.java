 ...
 * 
 * Calling with
 * {@code foo.friends(ImmutableMap.of("group", "coworker", "age", "42"))} yields
 * {@code /friends?group=coworker&age=42}.
 * <p>
 * Map keys and values representing parameter values are URL encoded by default.
 * Specify {@link #encoded() encoded=true} to change this behavior.
 * 
 * <pre>
 * <code>
 * &#64;GET("/friends")
 ...
 * </pre>
 * 
 * Calling with {@code foo.list(ImmutableMap.of("group", "coworker+bowling"))}
 * yields {@code /friends?group=coworker+bowling}.
 * <p>
