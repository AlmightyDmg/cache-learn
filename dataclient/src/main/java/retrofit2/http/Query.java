 ...
 * then URL encoded. {@code null} values are ignored. Passing a
 * {@link java.util.List List} or array will result in a query parameter for
 ...
 * <p>
 * Parameter names and values are URL encoded by default. Specify
 ...
 * </pre>
 * 
 * Calling with {@code foo.friends("foo+bar"))} yields
 * {@code /friends?group=foo+bar}.
 *
 * @see QueryMap
 * @see QueryName
 */
...
public @interface Query {
	...
	/**
	 * Specifies whether the parameter {@linkplain #value() name} and value are
	 * already URL encoded.
	 */
